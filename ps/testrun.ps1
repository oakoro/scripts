...
$access_token = (Get-AzAccessToken -TenantId "898ddc02-8cc0-4e10-9a8c-c0b5cbf7574b" -ResourceUrl https://management.core.windows.net).token
$sqlaccesstoken = (Get-AzAccessToken -TenantId "898ddc02-8cc0-4e10-9a8c-c0b5cbf7574b" -ResourceUrl https://management.core.windows.net).token
$FileOutput = "C:\Users\OkeAkoro\Downloads\MRTest\BPLicense.csv"
$apiHeaders = @{"Authorization" = "Bearer $accessToken"}

# Get list of subscriptions
$subs = Get-AzSubscription | Where-Object {$_.State -eq 'Enabled'} | Sort-Object
