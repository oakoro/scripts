...
where i.finished is not null and i.finished < @Threshold and q.name not in ('InvOCR','LOB Amendments','Lettings Onboarding')
...
from @queuetabl where Queuename = 'Activation Checklist'
