...
select * from dbo.BPAWorkQueueItem i inner join @QueuesToInclude q
on i.ident = q.ident and i.queueid = q.QueueID


--delete top(10) i
--from dbo.BPAWorkQueueItem i inner join @QueuesToInclude q
--on i.ident = q.ident and i.queueid = q.QueueID
