...
declare @nextPartitionID int, @alterpartitionschemestr nvarchar(400), @alterpartitionfunctionstr nvarchar(400), @get_prv nvarchar(400)
declare @partitionfunction nvarchar(50), @partitionscheme nvarchar(50)
set @partitionscheme = 'PS_Dynamic_NU'
...
--)
--begin
set @alterpartitionschemestr = 'alter partition scheme PS_dynamicBPASessionLogPartition next used [primary];'
