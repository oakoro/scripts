...
ALTER PROCEDURE [BPC].[aasp_getCopyDatesDelta] 
@maxCount INT
AS
...
IF @lastDateCopied = '1900-01-01 00:00:00.000'
	...
	SELECT ISNULL(@minDate,@lastDateCopied), ISNULL(@maxDate,@lastDateCopied), @tablename,@deltacol
	END
	ELSE
	IF @lastDateCopied <> '1900-01-01 00:00:00.000'
	BEGIN
