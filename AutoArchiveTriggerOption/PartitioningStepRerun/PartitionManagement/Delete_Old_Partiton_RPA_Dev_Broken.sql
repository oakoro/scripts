...
set @tablename = 'BPASessionLog_NonUnicode_PartitionTest_NCI'
set @tableschema = 'dbo'
set @partitionfuntion = 'pflogid_test'

select @lastprocessedid = 
logid from [BPC].[adf_watermark_sessionlog] where tablename = @tablename;
...
if @nextpartitionboundarytodelete is not null and @nextpartitionboundarytodelete < @lastprocessedid and @partitionboundarycount > 6
begin
...
--select  lastprocessedid from sessionlog_watermark

--update sessionlog_watermark
--set lastprocessedid = 401