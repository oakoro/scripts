...
--select @BackupFile
--select COUNT(*) from @BackupFiles where BackupType = 'D'
...
set @BackupFileConcat = ''
	...
	--select @BackupStr'@BackupStr',@BackupFileConcat'@BackupFileConcat'--,@BackupFileConcatFinal'@BackupFileConcatFinal'
...
select @LogicalStr'@LogicalStr'
select  @PhysicalStr '@PhysicalStr'

--if @LogicalFileConcat != ''
set @LogicalFileConcat = @LogicalFileConcat  +','+'Move ' +'''' +@LogicalStr +'''' + ' TO ' +'''' +@DBDestinationFolder +@PhysicalStr +''''
--else
--set @LogicalFileConcat = 'Move ' +'''' +@LogicalStr +'''' + ' TO ' +'''' +@DBDestinationFolder +@PhysicalStr +''''
...
--select @LogicalFileConcatFinal '@LogicalFileConcatFinal'
...
print @AlterDB
set @RestoreString = @RestoreFromString +@WithReplace --+@LogicalFileConcat +';'
print @RestoreString
end
else
begin
set @RestoreString = @RestoreFromString --+@With +@LogicalFileConcat +';'
print @RestoreString
end
...
FROM  DISK = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\adw_1.bak',  
DISK = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\adw_2.bak',  
DISK = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\adw_3.bak' 
WITH  FILE = 1,  NOUNLOAD,  STATS = 5
,Move 'AdventureWorks2017' TO 'C:\SQLTest\TestRestore\AdventureWorks2019.mdf',Move 'AdventureWorks2017_log' TO 'C:\SQLTest\TestRestore\AdventureWorks2019_log.ldf'


RESTORE DATABASE [AdventureWorks2019] 
FROM 
Disk ='C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\adw_1.bak',
...
WITH 
Move 'AdventureWorks2017' TO 'C:\SQLTest\TestRestore\AdventureWorks2019.mdf',
