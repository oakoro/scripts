/****** Object:  StoredProcedure [BPC].[aasp_delete_copied_Sessionlog_partition]    Script Date: 03/10/2023 10:54:18 ******/
SET ANSI_NULLS ON
GO
...
-- Script execution Example: BPC.aasp_delete_copied_Sessionlog_partitionTest 'dbo','BPASessionLog_NonUnicode','PF_Dynamic_NU',2
...
ALTER PROCEDURE [BPC].[aasp_delete_copied_Sessionlog_partitionTest]
...
SELECT @nextpartitionboundarytodelete '@nextpartitionboundarytodelete',
	   @truncatetablestr '@truncatetablestr',
	   @alterpartationstr '@alterpartationstr'
END
GO
