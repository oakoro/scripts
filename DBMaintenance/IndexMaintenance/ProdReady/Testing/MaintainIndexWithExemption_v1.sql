...
DECLARE @work_to_do table (objectid INT,indexid INT,partitionnum sysname,frag float)
DECLARE @work_to_do_final table (objectid INT,tablename NVARCHAR(130),indexid INT,indexname NVARCHAR(130),frag float,partitionnum sysname,status bit)
...
--WHERE tablename not in ('BPAStringPref');
