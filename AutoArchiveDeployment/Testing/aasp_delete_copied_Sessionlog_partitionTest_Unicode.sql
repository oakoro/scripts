/****** Object:  StoredProcedure [BPC].[aasp_delete_copied_Sessionlog_partition]    Script Date: 20/09/2023 17:48:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [BPC].[aasp_delete_copied_Sessionlog_partitionTest_Unicode] 
@tableschema NVARCHAR(20) = 'dbo',@partitionfunction NVARCHAR(50) = 'PF_Dynamic_NUTest', @partitionsretained TINYINT
