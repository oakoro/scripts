--/****** Object:  StoredProcedure [BPC].[aasp_delete_copied_Sessionlog_partition]    Script Date: 24/10/2023 12:08:22 ******/
--SET ANSI_NULLS ON
--GO
...
declare @tableschema NVARCHAR(20), @tablename NVARCHAR(400),@partitionfunction NVARCHAR(50),@partitionsretained TINYINT
set @tablename = 'BPASessionLog_NonUnicode'
set @tableschema = 'dbo'
set @partitionfunction = 'PF_Dynamic_NU_New'
set @partitionsretained = 1
--AS
...
select @nextpartitionboundarytodelete
