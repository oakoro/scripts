...
$FileOutput = "C:\temp\ConfirmSPDeploymentv2.csv"
...
$StorageAccountKey = "xxxxxrm+F77ZKpnsV6I9YmS9CKfZ9DU7Zxrje1zXX7vdgpC7KMBL0lx6bSZiEGRbJRdbQFukwTDOtdbS2+ASt5HEnjA==xxxxx"
...
'@
                ...
                #we just have 3 columns with a single value each.
                    try {
                        $dt = Invoke-Sqlcmd -ServerInstance $sql.properties.fullyQualifiedDomainName -Database $db -AccessToken $using:sqlaccesstoken -inputFile 'C:\Scripts\AutoArchiveDeployment\Testing\ConfirmSPDeploymentv2.sql'
                    }
                    catch {
