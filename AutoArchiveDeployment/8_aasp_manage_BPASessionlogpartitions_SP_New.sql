/****** Object:  StoredProcedure [BPC].[aasp_manage_BPASessionlogpartitions]    Script Date: 19/09/2023 17:02:15 ******/
SET ANSI_NULLS ON
GO
...
-- Alter statement added to change partition retention date from 6 to 5
-- =======================================================================================
