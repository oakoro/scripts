...
--Populate or update table  
	...
	VALUES 
	('BPASessionLog_NonUnicode','logid','1900-01-01'),
	('BPASessionLog_Unicode','logid','1900-01-01'),
	('BPAWorkQueueItem','finished','1900-01-01'),
	('BPAAuditEvents','eventdatetime','1900-01-01'),
	('BPAScheduleLog','instancetime','1900-01-01'),
	('BPAScheduleLogEntry','entrytime','1900-01-01'),
	('BPASession','enddatetime','1900-01-01')
	;
