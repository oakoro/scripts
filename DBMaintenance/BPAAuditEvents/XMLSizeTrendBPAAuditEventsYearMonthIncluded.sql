...
DATEPART(week,[eventdatetime])'Week',DATEPART(MONTH,[eventdatetime])'Month',
sum(isnull(datalength([eventdatetime]),0)
  ...
  GROUP BY DATEPART(YEAR,[eventdatetime]),DATEPART(week,[eventdatetime]) ,DATEPART(MONTH,[eventdatetime])
