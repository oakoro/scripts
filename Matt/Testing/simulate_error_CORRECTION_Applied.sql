 declare @startdatetime datetime = '2024-09-25 13:37:58.717', @enddatetime datetime --= '2024-09-23 12:05:29.707'
 ,@mstartdatetime datetime, @menddatetime datetime
 select @mstartdatetime = 
...
SELECT @mstartdatetime, @menddatetime
