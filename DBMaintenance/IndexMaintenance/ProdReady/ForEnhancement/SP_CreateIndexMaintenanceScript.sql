-- =====================================================================================
-- @version 24.10.14
-- Description: SP identify fragmented indexes and maintain
-- Script execution Example: dbo.BPCindexmaintenance 60
-- =======================================================================================

CREATE PROCEDURE BPCindexmaintenance
@maxruntime TINYINT --Maximum execution time in minutes
